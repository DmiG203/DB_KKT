...
AS
SELECT DISTINCT 
                         o.NumOP, pci.IP, bts.CompID, bts.Terminal_number, bts.Serial_number, bts.Terminal_model, bts.Software_versions_UPOS, bts.Contactless, bts.Loading_parameters, btp.PC_PathFolder, btp.PC_Serial_number, btp.PC_Model, 
                         btp.PC_Software_versions_UPOS, btp.LoadParmEXE, btp.GateDLL, btp.Sb_kernelDLL, det.Detected, btd.DriverVersion, bts.Update_date
...
WHERE        (bts.StatusID = 1) AND (bts.IsDeleted = 0)
