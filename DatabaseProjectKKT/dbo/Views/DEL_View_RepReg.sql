CREATE VIEW dbo.[DEL_View_RepReg]
AS
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' 1860
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'DEL_View_RepReg';
GO
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 17
         ...
         Width = 2205
         Width = 2085
         Width =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'DEL_View_RepReg';
GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'DEL_View_RepReg';
GO
